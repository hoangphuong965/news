...
class AdminSocialItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_social_item_show')->with('success', 'SocialItem được thêm vào thành công.');
    }
    ...
    public function update(Request $request,$id) 
    {
        ...
        return redirect()->route('admin_social_item_show')->with('success', 'SocialItem được cập nhật thành công.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin_social_item_show')->with('success', 'SocialItem xóa thành công.');
    }
}
